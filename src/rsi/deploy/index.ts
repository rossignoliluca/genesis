...
export class GitManager {
  ...
  private buildCommitMessage(
    ...
    // Footer
    parts.push('---');
    parts.push('🤖 Generated by Genesis RSI (Recursive Self-Improvement)');
...
export class PRManager {
  ...
  private buildPRBody(
    ...
    parts.push(`- **Approved**: ${plan.constitutionalApproval.approved ? '✅ Yes' : '❌ No'}`);
    for (const principle of plan.constitutionalApproval.principles) {
      const emoji = principle.satisfied ? '✅' : '❌';
